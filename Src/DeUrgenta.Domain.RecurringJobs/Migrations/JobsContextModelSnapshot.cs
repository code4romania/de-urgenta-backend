...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeUrgenta.RecurringJobs.Domain.Entities.ItemDetails", b =>
                {
                    b.Property<Guid>("NotificationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DeUrgenta.RecurringJobs.Domain.Entities.ItemDetails", b =>
                {
                    b.HasOne("DeUrgenta.RecurringJobs.Domain.Entities.Notification", "Notification")
                        .WithOne("ItemDetails")
                        .HasForeignKey("DeUrgenta.RecurringJobs.Domain.Entities.ItemDetails", "NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
