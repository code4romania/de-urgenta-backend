...
namespace DeUrgenta.Backpack.Api.Tests.Validators
{
    ...
    public class GetMyBackpacksValidatorShould
    {
        ...
        public async Task Invalidate_request_when_no_user_found_by_sub(string sub)
        {
            ...
            // Act
            var result = await sut.IsValidAsync(new GetMyBackpacks(sub), CancellationToken.None);
        ...
        public async Task Validate_when_user_was_found_by_sub()
        {
            ...
            // Act
            var result = await sut.IsValidAsync(new GetMyBackpacks(userSub), CancellationToken.None);
