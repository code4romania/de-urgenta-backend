...
namespace DeUrgenta.Backpack.Api.Validators
{
    public class GetBackpackContributorsValidator : IValidateRequest<GetBackpackContributors>
    {
        ...
        public async Task<ValidationResult> IsValidAsync(GetBackpackContributors request, CancellationToken ct)
        {
            ...
            var isContributor = await _context.BackpacksToUsers.AnyAsync(btu => btu.User.Id == user.Id && btu.Backpack.Id == request.BackpackId, cancellationToken: ct);
